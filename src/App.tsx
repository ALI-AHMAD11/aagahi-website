...
export default function App() {
  ...
  return (
    <div className={`min-h-screen flex flex-col bg-slate-950 text-slate-100 relative overflow-x-hidden ${language === "ur" ? "rtl font-sans" : "ltr font-sans"}`}>
      
      {/* Safe Cyber Background Glow Accents (Build-safe) */}
