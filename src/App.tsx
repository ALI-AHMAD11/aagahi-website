...
// Courtroom-themed scroll divider
...
export default function App() {
  ...
  return (
    <div 
      className={`min-h-screen flex flex-col relative overflow-x-hidden ${language === "ur" ? "rtl font-sans" : "ltr font-sans"}`}
      style={{ backgroundColor: "var(--color-brand-navy)", color: "var(--color-brand-offwhite)" }}
    >
      
      {/* Safe Ambient Glow Accents */}
              ...
              <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                  ...
                  <motion.div
                    ...
                    className="card flex flex-col justify-between cursor-pointer group"
                  >
                ...
                <div className="max-w-6xl mx-auto space-y-12">
                  ...
                  >
                    ...
                    <motion.div 
                      ...
                      className="card space-y-3 relative group"
                    >
                ...
                <div className="max-w-6xl mx-auto space-y-6 text-center">
                  ...
                  <div className="inline-flex items-center p-1.5 rounded-2xl bg-slate-950 border border-slate-800 shadow-xl">
                    <motion.button
                      ...
                      className={`btn ${page2SubTab === "rights" ? "btn-primary" : "btn-secondary"}`}
                    >
                      <Scale className="w-4 h-4 text-amber-300 inline mr-2" />
                    ...
                    <motion.button
                      ...
                      className={`btn ${page2SubTab === "guides" ? "btn-primary" : "btn-secondary"}`}
                    >
                      <FileText className="w-4 h-4 text-amber-300 inline mr-2" />
                ...
                <div className="max-w-6xl mx-auto space-y-6 text-center">
                  ...
                  <div className="inline-flex items-center p-1.5 rounded-2xl bg-slate-950 border border-slate-800 shadow-xl">
                    <motion.button
                      ...
                      className={`btn ${page3SubTab === "directory" ? "btn-primary" : "btn-secondary"}`}
                    >
                    ...
                    <motion.button
                      ...
                      className={`btn ${page3SubTab === "faqs" ? "btn-primary" : "btn-secondary"}`}
                    >
                      <HelpCircle className="w-4 h-4 text-amber-300 inline mr-2" />
