...
const CourtroomScrollDivider: React.FC = () => (
  <div
    className="flex items-center justify-center gap-4 py-2 select-none"
    aria-hidden="true"
  >
    <motion.span
...
export default function App() {
  ...
  const [page2SubTab, setPage2SubTab] = useState<"rights" | "guides">(
    "rights"
  );
        ...
        : [
            {
              ...
              caseDescription:
                "Illegal dispossession inquiry regarding residential plot in Lahore.",
              date: "2026-08-25",
              timeSlot: "11:00 AM",
  ...
  useEffect(() => {
    try {
      localStorage.setItem(
        "aagahi_saved_articles",
        JSON.stringify(savedArticleIds)
      );
    } catch {}
  }, [savedArticleIds]);
        ...
        <AnimatePresence mode="wait">
          ...
          {currentTab === "home" && (
            ...
            >
              ...
              <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                  ...
                  <p className="text-xs sm:text-sm text-slate-400 max-w-xl mx-auto">
                    Instant statutory answers, procedural walkthroughs,
                    emergency dispatch, and bar-certified advocate bookings.
                  </p>
                </motion.div>
                    ...
                    <div className="space-y-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-slate-400 mt-1">
                          Instant legal diagnosis with relevant
                          Constitutional Articles & PPC sections.
                        </p>
                      </div>
                    </div>
              ...
              <div
                id="solver-section"
                className={`border-t ${BORDER} pt-8`}
              >
                <LegalProblemSolver
              ...
              {/* HOW IT WORKS */}
              <section
                className={`bg-slate-900/80 py-16 px-4 sm:px-6 lg:px-8 border-y ${BORDER}`}
              >
                    ...
                    {[1, 2, 3, 4].map((step) => (
                      ...
                      >
                        ...
                        <h3 className="font-extrabold text-base text-white">
                          {t[
                            `step${step}Title` as keyof typeof t
                          ]}
                        </h3>

                        <p className="text-xs text-slate-400 leading-relaxed">
                          {t[
                            `step${step}Desc` as keyof typeof t
                          ]}
                        </p>
                      </motion.div>
                    ))}
              ...
              <section className="relative w-full h-[420px] sm:h-[500px] overflow-hidden mt-4">
                ...
                {/* Attached courtroom image */}
                <div
                  className="absolute inset-0 bg-cover bg-center bg-no-repeat"
                  style={{
                    backgroundImage:
                      "url('/courtroom-bottom.jfif')",
                  }}
                />
                ...
                <div className="absolute inset-0 bg-gradient-to-b from-slate-950 via-slate-950/25 to-slate-950" />
          ...
          {currentTab === "constitution" && (
            ...
            >
              <div
                className={`bg-slate-900 border-b ${BORDER} py-10 px-4 sm:px-6 lg:px-8`}
              >
                <div className="max-w-6xl mx-auto space-y-6 text-center">
                  ...
                  >
                    ...
                    <span>
                      Constitutional Literacy & Step-by-Step Guides
                    </span>
                  </div>
                  ...
                  >
                    ...
                    >
                      ...
                      <span>
                        Practical Legal Guides & FIR Procedures
                      </span>
                    </motion.button>
                  </div>
                </div>
              ...
              >
                <div className="max-w-6xl mx-auto space-y-6 text-center">
                  ...
                  >
                    ...
                    <span>
                      Bar Council Verified Advocates & Court FAQ
                    </span>
                  </div>
